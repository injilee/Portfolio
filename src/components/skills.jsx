        ...
        <S.SkillContainer>
          <S.SkillList>
            <S.SkillListItem>
              ...
              <p>
                SEO 방법을 숙지하여 프로젝트(
                <a href="http://chaunglimkim.shop/" target="blank">
                  natural-archive
                </a>
                ) 배포 했을 때 검색 시 도메인이 상위에 노출된 경험 있음. 시멘틱 태그를 사용한 마크업으로 필요한 태그들만
                사용 가능. 웹 접근성과 웹 표준성에 맞춰 코드 작성 가능. 디자인 시안을 화면에 그대로 반응형웹 구현 가능.
              </p>
            </S.SkillListItem>
            <S.SkillListItem>
            ...
            <S.SkillListItem>
              <span>React</span>
              <p>
                클래스, 함수형 컴포넌트, React Hooks로 프로젝트를 구현 경험. useState 관련 훅 사용 가능. React-router를
                사용해 SPA로 구현 가능. Redux를 사용해 공통 데이터 관리 경험 있음. Redux-persist로 state 초기화가 되지
                않도록 한 경험 있음.
              </p>
            </S.SkillListItem>
            <S.SkillListItem>
              <span>Rest API</span>
              <p>
                REST API 를 활용해 Youtube API, Cloudinary API, Firebase Authentication&Database API 로 웹 어플리케이션
                구현 경험.
              </p>
            </S.SkillListItem>
          </S.SkillList>
          ...
          <S.ToolList>
            ...
            <S.ToolListItem>
              <span>
                <a href="https://www.notion.so/injilee/0c2f1377919f4914ac7a610511996dbf?pvs=4" target="blank">
                  Notion
                </a>
              </span>
            </S.ToolListItem>
